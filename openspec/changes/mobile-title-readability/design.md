...
### Use a two-line clamp for mobile titles
Mobile now-playing titles will be allowed to wrap to two lines before truncating instead of remaining on a single `nowrap` line. This gives a meaningful readability improvement without introducing interaction state or motion.
