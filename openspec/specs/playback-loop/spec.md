# playback-loop Specification

## Purpose
Defines loop mode behavior for the YouTube IFrame Player. Covers the loop toggle control, single-video repeat (loop one), and queue wrap-around (loop all).
## Requirements
