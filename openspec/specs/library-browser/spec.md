...
When the library contains items, the system SHALL display them in the collapsible library panel as a scrollable list with thumbnail, title, channel name, and tags.
