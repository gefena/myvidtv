...
## Purpose
Defines the ability for users to edit tags on library items after they have been added.
...
- **WHEN** the user clicks the "# Tags" button on a library card in the active library
...
- **THEN** no "# Tags" button is present on any archived card
